...
const BgGradient: React.FC<BgGradientProps> = ({
    ...
    React.useEffect(() => {
        setColorsArray(resolvedTheme === 'dark' ? (Array.isArray(darkThemeColors) ? darkThemeColors : [darkThemeColors]) : (Array.isArray(colors) ? colors : [colors]));
    }, [colors, darkThemeColors, resolvedTheme]);
